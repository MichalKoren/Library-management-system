...
public class LibraryUser extends User {
    ...
    //Metoda jest prywatna ponieważ dodanie ksiazki do historii wypożyczeń nastepuje
    // wraz ze zwrotem wypozyczenia ksiazki do biblioteki
...
//najpierw sprawdzamy dla bezpieczeństwa, czy dany użytkownik na pewno
// aktualnie posiada taką książkę na swoim koncie (metoda remove kolekcji
// zwraca true, jeśli element zostanie pomyślnie usunięty).
